...
class DefaultFooter extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <nav className='relative w-full flex items-center justify-between flex-wrap sm:p-1 sm:pt-1'>
          {/* Mobile view menu rows for each section */}
          <div className='flex-col w-full justify-around text-white items-start bg-primary-color-100 text-left lg:hidden'>
            {/* Company section */}
